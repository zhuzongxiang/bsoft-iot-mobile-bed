...
public class XmlResp {
	 ...
	 * 构造设备状态响应
	 */
	public static final String buildDeviceStatus(String fromUser, String toUser,
			String deviceType, String deviceID, String status) {
		return String.format(DEVICE_STATUS, fromUser, toUser, time(),
				MsgType.DEVICE_STAUTS, deviceType, deviceID, status);
	}
